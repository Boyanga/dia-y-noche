...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/DiaYNoche.oep", "assets/data/DiaYNoche.oep");
		type.set ("assets/data/DiaYNoche.oep", AssetType.TEXT);
		path.set ("assets/data/DiaYNoche1.oel", "assets/data/DiaYNoche1.oel");
		type.set ("assets/data/DiaYNoche1.oel", AssetType.TEXT);
		path.set ("assets/images/anochecer.png", "assets/images/anochecer.png");
		type.set ("assets/images/anochecer.png", AssetType.IMAGE);
		path.set ("assets/images/diaynoche.png", "assets/images/diaynoche.png");
		type.set ("assets/images/diaynoche.png", AssetType.IMAGE);
		path.set ("assets/images/fantasma.png", "assets/images/fantasma.png");
		type.set ("assets/images/fantasma.png", AssetType.IMAGE);
		...
		id = "assets/data/DiaYNoche.oep";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/DiaYNoche1.oel";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/anochecer.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/diaynoche.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/fantasma.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
